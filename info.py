...
API_ID = int(environ.get('API_ID', '27934630')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '5fbce12d70c2bdedf8b1e549e8ae818b')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8513837851:AAFuFxe1LKPmuDL94hJ7PqKshlsQklMJhyY")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5529765823').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002545505617').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003223875696'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003223875696'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003223875696'))  # Premium logs channel id
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Malayalam_Movies_786')  # Support group link (make sure bot is admin)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Malayalam_Movies_786")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Malayalam_Movies_916")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Movies_Logs_786")   # Third tutorial link for verification
